package empolyesecurity.greendaogenerator;
...
public class MyGenerator {
    public static void main(String[] args) {
        Schema schema = new Schema(1, "empolyesecurity.greendao.dp"); // Your app package name and the (.db) is the folder where the DAO files will be generated into.
